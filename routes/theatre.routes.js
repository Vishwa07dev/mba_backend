...
module.exports = function (app) {
    ...
    app.put("/mba/api/v1/theatres/:id", [authJwt.verifyToken, authJwt.isAdmin, verifyTheatreReqBody.validateTheatreRequestBody], theatreController.updateTheatre);
    app.delete("/mba/api/v1/theatres/:id", [authJwt.verifyToken, authJwt.isAdmin], theatreController.deleteTheatre);
    app.put("/mba/api/v1/theatres/:id/movies", [authJwt.verifyToken, authJwt.isAdmin], theatreController.addMoviesToATheater);
